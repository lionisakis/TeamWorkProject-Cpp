...
UI= $(UDIR)Fight.o $(UDIR)Util.o $(UDIR)Market.o $(UDIR)SpawnDespawnHero.o $(UDIR)Block.o $(UDIR)Grid.o
...
UId= $(UDIR)Fight.d $(UDIR)Util.d $(UDIR)Market.d $(UDIR)SpawnDespawnHero.d $(UDIR)Block.d $(UDIR)Grid.d
